                ...
                children: <Widget>[
                  ...
                  Padding(
                    ...
                    child: TextFormField(
                      validator: (value) {
                        if (value == null || value.isEmpty) {
                          return 'ERROR: Please enter Aadhaar number!';
                        } else if (value.length != 12)
                          return 'ERROR: Aadhaar number should be of 12 digits!';
                        return null;
                      },
                      //maxLength: 12,
                      style: const TextStyle(
                  ...
                  Padding(
                    ...
                    child: TextFormField(
                      validator: (value) {
                        if (value == null || value.isEmpty) {
                          return 'ERROR: Please enter PAN Number!';
                        } else if (value.length != 10)
                          return 'ERROR: PAN number should be of 10 characters!';
                        return null;
                      },
                      style: const TextStyle(
                        fontSize: 15,
